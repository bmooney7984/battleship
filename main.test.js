...
describe("board methods", () => {
  ...
  test("listValidStarts filters out conflicts with occupied squares and board edges", () => {
    const board = main.boardFactory({})
    board.shipLocations = {cruiser: ["D2", "D3", "D4"]}
    expect(board.listValidStarts("patrol boat", "horizontal")).toStrictEqual(["A1", "A2", "A3", "A4", "A5", "A6", "A7", "A8", "A9",
